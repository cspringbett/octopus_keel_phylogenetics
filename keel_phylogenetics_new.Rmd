...
echo "  FORMAT DATATYPE=DNA MISSING=? GAP=- INTERLEAVE=YES;
  ...
  [16s]" >> complete.nxs 
sed -n 7,136p x16s.nxs >> complete.nxs
echo "
   [COI]" >> complete.nxs
sed -n 7,136p coi.nxs >> complete.nxs
echo "
   [COIII]" >> complete.nxs
sed -n 7,136p coiii.nxs >> complete.nxs
echo "  ;
END;
